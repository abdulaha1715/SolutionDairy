...
<html lang="en" class="a0">
    ...
    <body class="dark:a1">
        <header class="header a2 a3 a4 a5 a6 a7 a8 a9">
            <div class="aa">
                <div class="a8 ab[-16px] a9 ac ad">
                    <div class="ae af ag">
                        <a href="{{ route('frontend.index') }}" class="a7 ah ai header-logo">
                            <img src="{{ asset('frontend/images/logo/logo-2.svg') }}" alt="logo" class="a7 dark:aj" />
                            <img src="{{ asset('frontend/images/logo/logo.svg') }}" alt="logo" class="a7 aj dark:ah" />
                        </a>
                    </div>
                    <div class="a8 ae ac a9 a7">
                        <div>
                            <button id="navbarToggler" aria-label="Mobile Menu" class="ah a3 ak al/2 am[-50%] lg:aj focus:an ao ap aq[6px] ar">
                                <span class="ad as[30px] at[2px] au[6px] ah av dark:aw"></span>
                                <span class="ad as[30px] at[2px] au[6px] ah av dark:aw"></span>
                                <span class="ad as[30px] at[2px] au[6px] ah av dark:aw"></span>
                            </button>
                            <nav id="navbarCollapse" class="a3 ax lg:ay lg:ae xl:az aw dark:av lg:dark:a2 lg:a2 aA ar aB[250px] a7 lg:ag lg:a7 ak aC aj lg:ah lg:aD lg:aE">
                                <ul class="aF lg:a8">
                                    <li class="ad aG">
                                        <a href="{{ route('frontend.index') }}" class="menu-scroll aH text-dark dark:aI group-hover:aJ aK lg:aL lg:aM lg:aN a8 aO lg:aP">
                                            Problems
                                        </a>
                                    </li>
                                    <li class="ad aG">
                                        <a href="{{ route('frontend.index') }}" class="menu-scroll aH text-dark dark:aI group-hover:aJ aK lg:aL lg:aM lg:aN a8 aO lg:aP lg:aQ xl:aR">
                                            Category
                                        </a>
                                    </li>
                                    <li class="ad aG">
                                    ...
                                    {{-- <li class="ad aG submenu-item">
                                        <a
                                            ...
                                            class="aH text-dark dark:aI group-hover:aJ aK lg:aL lg:aM lg:aS lg:aT a8 aO lg:aP lg:aQ xl:aR ad after:a3 after:aU after:aV after:aW after:aX after:aY after:aZ lg:after:a_ after:a10 after:al/2 after:am[-50%] after:a11[-2px]"
                                        >
                                            Pages
                                        </a>
                                        <div class="submenu aj ad lg:a3 as[250px] aC lg:a12[110%] a5 a13 lg:aA a14 lg:ah lg:a15 lg:a16 group-hover:a17 lg:group-hover:a18 lg:group-hover:aC aw dark:av a19[top] a1a">
                                            <a href="about.html" class="ah a1b a1c aq[10px] ae text-dark dark:aI hover:aJ">
                                                About Page
                                            </a>
                                            <a href="contact.html" class="ah a1b a1c aq[10px] ae text-dark dark:aI hover:aJ">
                                                Contact Page
                                            </a>
                                            <a href="blog-grids.html" class="ah a1b a1c aq[10px] ae text-dark dark:aI hover:aJ">
                                                Blog Grid Page
                                            </a>
                                            <a href="blog-sidebar.html" class="ah a1b a1c aq[10px] ae text-dark dark:aI hover:aJ">
                                                Blog Sidebar Page
                                            </a>
                                            <a href="blog-details.html" class="ah a1b a1c aq[10px] ae text-dark dark:aI hover:aJ">
                                                Blog Details Page
                                            </a>
                                            <a href="signin.html" class="ah a1b a1c aq[10px] ae text-dark dark:aI hover:aJ">
                                                Sign In Page
                                            </a>
                                            <a href="signup.html" class="ah a1b a1c aq[10px] ae text-dark dark:aI hover:aJ">
                                                Sign Up Page
                                            </a>
                                            <a href="404.html" class="ah a1b a1c aq[10px] ae text-dark dark:aI hover:aJ">
                                                404 Page
                                            </a>
                                        </div>
                                    </li> --}}
                        ...
                        <div class="a8 a1d a9 a1e lg:a1f">
                            ...
                            <ul>
                                <li class="ad aG submenu-item">
                                    <a href="javascript:void(0)" class="aH text-dark dark:aI group-hover:aJ aK lg:aL lg:aM lg:aS lg:aT a8 aO lg:aP lg:aQ xl:aR ad after:a3 after:aU after:aV after:aW after:aX after:aY after:aZ lg:after:a_ after:a10 after:al/2 after:am[-50%] after:a11[-2px]">
                                        <div class="u-avatar">
                                        ...
                                        <div class="submenu aj ad lg:a3 as[250px] aC lg:a12[110%] a5 a13 lg:aA a14 lg:ah lg:a15 lg:a16 group-hover:a17 lg:group-hover:a18 lg:group-hover:aC aw dark:av a19[top] a1a">
                                            <a href="about.html" class="ah a1b a1c aq[10px] ae text-dark dark:aI hover:aJ"> About Page </a>
                                            <a href="contact.html" class="ah a1b a1c aq[10px] ae text-dark dark:aI hover:aJ"> Contact Page </a>
                                        </div>
                                </li>
                            </ul>
                            @else
                                <a href="signin.html" class="aj md:ah aH a1g a1h dark:aI hover:aJ a1i a1j">
                                    Sign In
                                </a>
                                <a href="signup.html" class="aj md:ah aH a1g aI a1k a1i a1l md:a1m lg:az xl:a1m hover:a1n hover:a1o a13 a1p a1q a1a">
                                    Sign Up
                                </a>
                            @endif

                            <div>
                                <label for="darkToggler" class="a1r a1s a1t md:a1u md:a1v a1w a8 a9 a1x a1y dark:a1z a1A dark:aI">
                                    ...
                                    <svg viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="aj dark:ah a1D a1E md:a1F md:a1G">
        ...
        <section id="" class="ad a1H a1I[120px] a1J[110px] md:a1I[150px] md:a1J[120px] xl:a1I[180px] xl:a1J[160px] 2xl:a1I[210px] 2xl:a1J[200px]">
            <div class="aa">
                    ...
                    <div class="a7 ae">
                        <div class="a1L aB[570px] a1M wow fadeInUp" data-wow-delay=".2s">
                            ...
                            <p class="a1R a1T md:a27 a1U md:a1U a1S dark:aI dark:a3E a2s">
                                A Complete Tailwind CSS Web Template Crafted for - Startup, SaaS, Business, Software and Agencies. Comes with high-quality design and everything you need!
                            </p>
                            <div class="a8 a9 a1x">
                                <a href="#features" class="aH a2P aI a1k a3q a1l hover:a2i a3F a13 a1p a1a a2j">
                                    Get Started
                                </a>
                                <a href="#about" class="aH a2P a1A a1 a29 dark:aI dark:aw dark:a29 a3q a1l hover:a3G dark:hover:a3G a3F a13 a1p a1a a2j">
                                    Learn More
                                </a>
                            </div>
                        </div>
        ...
        <section id="blog" class="bg-primary a1Z a1I[120px] a3A">
            <div class="aa">
                <div class="a8 a1K ab[-16px]">
                    <div class="a7 ae">
                        <div class="a1L aB[570px] a1M a3s[100px] wow fadeInUp" data-wow-delay=".1s">
                ...
                <div class="a8 a1K ab[-16px] a1x">
                    ...
                    <div class="a7 md:aU/3 lg:a1_/2 xl:a1_/3 ae">
                        <div class="ad aw dark:av a33 a13 a2p a1V wow fadeInUp" data-wow-delay=".1s">
                            <a href="{{ route('frontend.single', $problem->id) }}" class="a7 ah ad">
                                <span class="a3 a34 a35 a1k a1w aM a9 a1x aK ae a2P a1b aI capitalize">
                                    {{ $problem->visibility }}
                                </span>
                                ...
                                <div class="a8 a9">
                                    <div class="a8 a9 a39 a2O xl:a3a 2xl:a39 xl:a2A 2xl:a2O a3b a2z a2M dark:a2o dark:a2M">
                                        <div class="aB[40px] a7 at[40px] a1w a2p a2G">
                                            <img src="{{$problem->user->avatar['url']}}" alt="author" class="a7" />
                                        </div>
                                        <div class="a7">
                    ...
                    <div class="a7 md:aU/3 lg:a1_/2 xl:a1_/3 ae">
                        <div class="ad aw dark:av a33 a13 a2p a1V wow fadeInUp" data-wow-delay=".1s">
                            <p class="border py-6 text-center text-xl text-red-700">No Problem Found!</p>
                        </div>
                    </div>
                    @endforelse
                </div>
        ...
        <footer class="ad a1H a1k a1Z a1I[100px] wow fadeInUp" data-wow-delay=".1s">
            <div class="aa">
                <div class="a8 a1K ab[-16px]">
                    <div class="a7 md:a1_/2 lg:a20/12 xl:a1D/12 ae">
                        <div class="a21 aB[360px]">
                            <a href="{{ route('frontend.index') }}" class="a22 a23">
                                <img src="{{ asset('frontend/images/logo/logo-2.svg') }}" alt="logo" class="a7 dark:aj" />
                                <img src="{{ asset('frontend/images/logo/logo.svg') }}" alt="logo" class="a7 aj dark:ah" />
                            </a>
        ...
        <a href="javascript:void(0)" class="aj a9 a1x a1k aI a2c a2d a13 a2e a2f a2g a2h a1Y[999] hover:a1n hover:a2i a1p a1a a2j back-to-top a2k">
